...
import org.delcom.services.DongengService
...
fun Application.configureRouting() {
    ...
    val dongengService: DongengService by inject()
    ...
    routing {
        ...
        route("/dongeng") {
            get {
                dongengService.getAllDongengs(call)
            }
            post {
                dongengService.createDongeng(call)
            }
            get("/{id}") {
                dongengService.getDongengById(call)
            }
            put("/{id}") {
                dongengService.updateDongeng(call)
            }
            delete("/{id}") {
                dongengService.deleteDongeng(call)
            }
            get("/{id}/image") {
                dongengService.getDongengImage(call)
            }
        }
